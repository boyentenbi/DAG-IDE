...
var digit_13955 = (vlq & cljs.source_map.base64_vlq.vlq_base_mask);
var vlq_13956__$1 = (vlq >>> cljs.source_map.base64_vlq.vlq_base_shift);
while(true){
if((vlq_13956__$1 > (0))){
var digit_13957__$1 = (digit_13955 | cljs.source_map.base64_vlq.vlq_continuation_bit);
sb.append(cljs.source_map.base64.encode(digit_13957__$1));

var G__13958 = (vlq_13956__$1 & cljs.source_map.base64_vlq.vlq_base_mask);
var G__13959 = (vlq_13956__$1 >>> cljs.source_map.base64_vlq.vlq_base_shift);
digit_13955 = G__13958;
vlq_13956__$1 = G__13959;
continue;
} else {
sb.append(cljs.source_map.base64.encode(digit_13955));
}
break;
}
...
var G__13960 = i__$1;
var G__13961 = result__$1;
var G__13962 = shift__$1;
i = G__13960;
result = G__13961;
shift = G__13962;
continue;
