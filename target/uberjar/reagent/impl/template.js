...
reagent.impl.template.NativeWrapper.cljs$lang$ctorPrWriter = (function (this__6850__auto__,writer__6851__auto__,opt__6852__auto__){
return cljs.core._write(writer__6851__auto__,"reagent.impl.template/NativeWrapper");
});
...
var G__18903 = o;
(G__18903[reagent.impl.template.cached_prop_name(k)] = (reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
return (function() { 
var G__18904__delegate = function (args){
...
while (G__18905__i < G__18905__a.length) {G__18905__a[G__18905__i] = arguments[G__18905__i + 0]; ++G__18905__i;}
  args = new cljs.core.IndexedSeq(G__18905__a,0);
} 
return G__18904__delegate.call(this,args);};
...
return G__18904__delegate(args);
});
...
if(cljs.core.truth_((function (){var and__6232__auto__ = cljs.core.some_QMARK_(reagent.impl.template.find_dom_node);
if(and__6232__auto__){
var and__6232__auto____$1 = cljs.core.some_QMARK_(jsprops);
if(and__6232__auto____$1){
var and__6232__auto____$2 = (jsprops["hasOwnProperty"])("onChange");
...
var G__18911 = jsprops;
(G__18911["defaultValue"] = value);

(G__18911["onChange"] = ((function (G__18911,v,value,on_change){
return (function (p1__18909_SHARP_){
return reagent.impl.template.input_handle_change(this$,on_change,p1__18909_SHARP_);
});})(G__18911,v,value,on_change))
);
...
var vec__18918 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__18918,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__18918,(1),null);
var class$ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__18918,(2),null);
...
var jsprops = {"argv": v};
var temp__4661__auto___18923 = reagent.impl.template.key_from_vec(v);
if((temp__4661__auto___18923 == null)){
} else {
var key_18924 = temp__4661__auto___18923;
(jsprops["key"] = key_18924);
}

return (reagent.impl.util.react["createElement"])(c,jsprops);
});
reagent.impl.template.adapt_react_class = (function reagent$impl$template$adapt_react_class(c){
var G__18926 = (new reagent.impl.template.NativeWrapper());
(G__18926["name"] = c);
...
var G__18928 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [reagent.impl.template.reagent_input(),argv,comp,jsprops,first_child], null),cljs.core.meta(argv));
return (reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1(G__18928) : reagent.impl.template.as_element.call(null,G__18928));
} else {
...
var len__7319__auto___18934 = arguments.length;
var i__7320__auto___18935 = (0);
while(true){
if((i__7320__auto___18935 < len__7319__auto___18934)){
args__7326__auto__.push((arguments[i__7320__auto___18935]));

var G__18936 = (i__7320__auto___18935 + (1));
i__7320__auto___18935 = G__18936;
continue;
} else {
}
break;
...
return reagent.impl.template.hiccup_err.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),argseq__7327__auto__);
});
...
reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq18932){
var G__18933 = cljs.core.first(seq18932);
var seq18932__$1 = cljs.core.next(seq18932);
return reagent.impl.template.hiccup_err.cljs$core$IFn$_invoke$arity$variadic(G__18933,seq18932__$1);
});
...
break;
default:
var G__18940 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(v,(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null);
v = G__18940;
continue;
...
var n__7159__auto___18943 = a.length;
var i_18944 = (0);
while(true){
if((i_18944 < n__7159__auto___18943)){
(a[i_18944] = reagent.impl.template.as_element((a[i_18944])));
...
var a = cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(s);
var n__7159__auto___18946 = a.length;
var i_18947 = (0);
while(true){
if((i_18947 < n__7159__auto___18946)){
var val_18948 = (a[i_18947]);
if((cljs.core.vector_QMARK_(val_18948)) && ((reagent.impl.template.key_from_vec(val_18948) == null))){
(o["no-key"] = true);
} else {
}

(a[i_18947] = reagent.impl.template.as_element(val_18948));
...
var ctx = {};
var vec__18953 = reagent.ratom.check_derefs(((function (ctx){
return (function (){
return reagent.impl.template.expand_seq_dev(x,ctx);
});})(ctx))
);
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__18953,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__18953,(1),null);
...
var G__18957 = (cljs.core.count(argv) - first_child);
switch (G__18957) {
case (0):
...
break;
default:
return (reagent.impl.util.react["createElement"]).apply(null,cljs.core.reduce_kv(((function (G__18957){
