...
if((i < len)){
var k = (ks[i]);
var G__18844 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(m,cljs.core.keyword.cljs$core$IFn$_invoke$arity$1(k),(o[k]));
var G__18845 = (i + (1));
m = G__18844;
i = G__18845;
continue;
...
return (cljs.core.fn_QMARK_(c)) && (cljs.core.some_QMARK_((function (){var G__18849 = c;
var G__18849__$1 = (((G__18849 == null))?null:G__18849.prototype);
if((G__18849__$1 == null)){
return null;
} else {
return (G__18849__$1["reagentRender"]);
}
})()));
});
reagent.impl.component.react_class_QMARK_ = (function reagent$impl$component$react_class_QMARK_(c){
return (cljs.core.fn_QMARK_(c)) && (cljs.core.some_QMARK_((function (){var G__18853 = c;
var G__18853__$1 = (((G__18853 == null))?null:G__18853.prototype);
if((G__18853__$1 == null)){
return null;
} else {
return (G__18853__$1["render"]);
}
})()));
});
...
var G__18857 = cljs.core.apply.cljs$core$IFn$_invoke$arity$3(cljs.core.vector,res,args);
return (reagent.impl.component.as_element.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.component.as_element.cljs$core$IFn$_invoke$arity$1(G__18857) : reagent.impl.component.as_element.call(null,G__18857));
};
...
var _STAR_current_component_STAR_18864 = reagent.impl.component._STAR_current_component_STAR_;
...
}finally {reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR_18864;
}});
...
var G__18872 = (((key instanceof cljs.core.Keyword))?key.fqn:null);
switch (G__18872) {
...
return ((function (G__18872){
return (function reagent$impl$component$custom_wrapper_$_getInitialState(){
var c = this;
var G__18875 = reagent.impl.component.state_atom(c);
var G__18876 = f.call(c,c);
return (cljs.core.reset_BANG_.cljs$core$IFn$_invoke$arity$2 ? cljs.core.reset_BANG_.cljs$core$IFn$_invoke$arity$2(G__18875,G__18876) : cljs.core.reset_BANG_.call(null,G__18875,G__18876));
});
;})(G__18872))
...
var or__6244__auto__ = reagent.impl.util._STAR_always_update_STAR_;
...
var c = this;
var G__18878_18880 = (c["cljsRatom"]);
if((G__18878_18880 == null)){
} else {
reagent.ratom.dispose_BANG_(G__18878_18880);
}
...
if(cljs.core.truth_((function (){var and__6232__auto__ = wrap;
...
var renders_18883 = cljs.core.select_keys(fmap,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$render,cljs.core.cst$kw$reagentRender,cljs.core.cst$kw$componentFunction], null));
var render_fun_18884 = cljs.core.first(cljs.core.vals(renders_18883));
if((cljs.core.count(renders_18883) > (0))){
} else {
...
if(((1) === cljs.core.count(renders_18883))){
} else {
...
if(cljs.core.ifn_QMARK_(render_fun_18884)){
} else {
throw (new Error([cljs.core.str("Assert failed: "),cljs.core.str([cljs.core.str("Render must be a function, not "),cljs.core.str(cljs.core.pr_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.array_seq([render_fun_18884], 0)))].join('')),cljs.core.str("\n"),cljs.core.str("(ifn? render-fun)")].join('')));
}


var render_fun = (function (){var or__6244__auto__ = cljs.core.cst$kw$reagentRender.cljs$core$IFn$_invoke$arity$1(fmap);
if(cljs.core.truth_(or__6244__auto__)){
return or__6244__auto__;
} else {
...
var render_fun__$1 = (function (){var or__6244__auto__ = render_fun;
if(cljs.core.truth_(or__6244__auto__)){
return or__6244__auto__;
} else {
...
var name = [cljs.core.str((function (){var or__6244__auto__ = cljs.core.cst$kw$displayName.cljs$core$IFn$_invoke$arity$1(fmap);
if(cljs.core.truth_(or__6244__auto__)){
return or__6244__auto__;
} else {
...
var name__$1 = (function (){var G__18882 = name;
switch (G__18882) {
case "":
...
var elem = (function (){var G__18893 = (function (){var or__6244__auto__ = (function (){var G__18895 = c;
if((G__18895 == null)){
return null;
} else {
return (G__18895["_reactInternalInstance"]);
}
})();
if(cljs.core.truth_(or__6244__auto__)){
return or__6244__auto__;
...
return (G__18893["_currentElement"]);
}
})();
var name = (function (){var G__18896 = elem;
var G__18896__$1 = (((G__18896 == null))?null:(G__18896["type"]));
if((G__18896__$1 == null)){
return null;
} else {
return (G__18896__$1["displayName"]);
}
})();
var path = (function (){var G__18897 = elem;
var G__18897__$1 = (((G__18897 == null))?null:(G__18897["_owner"]));
var G__18897__$2 = (((G__18897__$1 == null))?null:reagent$impl$component$component_path(G__18897__$1));
if((G__18897__$2 == null)){
return null;
} else {
return [cljs.core.str(G__18897__$2),cljs.core.str(" > ")].join('');
}
})();
...
var n = (function (){var or__6244__auto__ = reagent.impl.component.component_path(c);
if(cljs.core.truth_(or__6244__auto__)){
return or__6244__auto__;
} else {
var G__18899 = c;
var G__18899__$1 = (((G__18899 == null))?null:G__18899.constructor);
if((G__18899__$1 == null)){
return null;
} else {
return reagent.impl.util.fun_name(G__18899__$1);
}
}
})();
